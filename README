...
This is a re-write of the [original TextNSP](http://search.cpan.org/dist/Text-NSP/) by Ted Pedersen.

The rationale, design and improvements are described [in this paper](https://github.com/BjoernKW/Publications/raw/master/Re-write_of_Text-NSP.pdf) in more detail.

Below you'll find the original README:

NAME
    README for Ngram Statistics Package

    Last Updated for Version 0.91, February 19, 2006
...
DESCRIPTION
  1. Introduction
    ...
    Program bin/count.pl takes flat text files as input and generates a list
    ...
    Program bin/statistic.pl takes as input a list of Ngrams with their
    ...
    bin/Utils/rank.pl takes as input two files output by statistic.pl and
    ...
    bin/Utils/kocos.pl takes as input a file output by count.pl or
    ...
    co-occurs with a (k-1)th co-occurrence of the given target WORD. So A is
    a 2nd order co-occurrence of X if X occurs with B and B occurs with A.
    Put more concretely in "New York", "New" and "York" co-occur (the are
    1st order co-occurrences). In "New Jack", "New" and "Jack" co-occur.
    Thus, "Jack" and "York" are second order co-occurrences because they
    both co-occur with "New".

    bin/Utils/combig.pl will take the output of count.pl and find unordered
    ...
    bin/Utils/huge-count.pl allows a user to run count.pl on much larger
    corpora. It essentially divides a corpora into pieces, and then uses
    count.pl to count piece, and then recombines the counts to get the final
    output. huge-count.pl also uses bin/Utils/huge-combine.pl,
    bin/Utils/split-data.pl, and bin/Utils/sort-bigrams.pl.
  ...
  6. Program statistic.pl:
   ...
   6.5. The Measures of Association Provided in This Distribution:
    ...
    The bigram measures are:
      ...
      1) Dice Coefficient (Text::NSP::Measures::2D::Dice::dice)
      2) Fishers exact test - left sided (Text::NSP::Measures::2D::Fisher::left)
      3) Fishers exact test - right sided (Text::NSP::Measures::2D::Fisher::right)
      4) Fishers twotailed test - right sided (Text::NSP::Measures::2D::Fisher::twotailed)
      5) Jaccard Coefficient (Text::NSP::Measures::2D::Dice::jaccard)
      6) Log-likelihood ratio (Text::NSP::Measures::2D::MI::ll)
      7) Mutual Information (Text::NSP::Measures::2D::MI::tmi)
      8) Odds Ratio (Text::NSP::Measures::2D::odds)
      9) Pointwise Mutual Information (Text::NSP::Measures::2D::MI::pmi)
      10) Phi Coefficient (Text::NSP::Measures::2D::CHI::phi)
      11) Pearson's Chi Squared Test (Text::NSP::Measures::2D::CHI::x2)
      12) Poisson Stirling Measure (Text::NSP::Measure::2D::MI::ps)
      13) T-score (Text::NSP::Measures::2D::CHI::tscore)

    The trigram measures are:

      1) Log-likelihood ratio (Text::NSP::Measures::3D::MI::ll)
      2) Mutual Information (Text::NSP::Measures::3D::MI::tmi)
      3) Pointwise Mutual Information (Text::NSP::Measures::3D::MI::pmi)
      4) Poisson Stirling Measure (Text::NSP::Measure::3D::MI::ps)
  ...
  7. Referencing:
    ...
    paper about NSP that could provide a suitable reference:
    ...
    This paper is found in Docs/cicling2003.(ps|pdf)
...
BUGS
    Date of Last Update 02/19/06 by Saiyam
...
SEE ALSO
    ...
    To convert this document ...
      ...
      into html:       pod2html README.pod > README.html

      into plain text: pod2text README.pod > README.text

  REFERENCES
    1   L. Wall, T. Christiansen and J. Orwant. 2000. Programming Perl.
        O'Reilly.

    2   S. Banerjee and T. Pedersen. 2003. The Design, Implementation and
        Use of the Ngram Statistics Package. Proceedings of the Fourth
        International Conference on Intelligent Text Processing and
        Computational Linguistics, 2003, February, Mexico City. (Available
        in this distribution as cicling2003.pdf or cicling2003.ps).

  WEB PAGES
    * NSP Home: http://www.d.umn.edu/~tpederse/nsp.html
    * Sourceforge: http://sourceforge.net/projects/ngram
    * CPAN: http://search.cpan.org/dist/Text-NSP/
    * Mailing List : http://groups.yahoo.com/group/ngram/
