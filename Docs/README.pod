...
Last Updated for Version 0.93, May 20, 2006
...
Program bin/count.pl takes flat text files as input and generates a list of
...
Various utility programs are found in bin/Utils/ and take as their input the
results (output) from count.pl and/or statistic.pl.
...
bin/Utils/kocos.pl takes as input a file output by count.pl or statistic.pl
...
L. Wall, T. Christiansen and J. Orwant. 2000. Programming Perl. O'Reilly.

=item 2

S. Banerjee and T. Pedersen. 2003. The Design, Implementation and Use of
the Ngram Statistics Package. Proceedings of the Fourth International
Conference on Intelligent Text Processing and Computational Linguistics,
2003, February, Mexico City. (Available in this distribution as
cicling2003.pdf or cicling2003.ps).
...
=item * NSP Re-implementation:	http://topicalizer.com/bwilmsmann/wiki/index.php/TextNSP

=item * NSP Home:      			http://www.d.umn.edu/~tpederse/nsp.html

=item * Sourceforge:   			http://sourceforge.net/projects/ngram

=item * CPAN:          			http://search.cpan.org/dist/Text-NSP/

=item * Mailing List : 			http://groups.yahoo.com/group/ngram/
